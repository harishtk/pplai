...
import com.aiavatar.app.commons.util.concurrent.AppExecutors;
...
public class CachedInflater {
    ...
    private static final String TAG = com.aiavatar.app.Log.tag(CachedInflater.class);
    ...
    private static class ViewCache {
        ...
        private static final Executor ENQUEUING_EXECUTOR = new SerialExecutor(AppExecutors.BOUNDED);
        ...
        void cacheUntilLimit(@NonNull Context context, @LayoutRes int layoutRes, @Nullable ViewGroup parent, int limit) {
            ...
            int existingCount = getOrDefault(cache, layoutRes, Collections.emptyList()).size();
        ...
        @MainThread
        @Nullable
        View pull(@LayoutRes int layoutRes, @NonNull Configuration configuration) {
