package com.example.app.commons.presentation.dialog
...
import com.example.app.databinding.DialogSimpleAltBinding

class SimpleDialogAlt constructor(
    context: Context,
    ...
    private lateinit var binding: DialogSimpleAltBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogSimpleAltBinding.inflate(layoutInflater)
        ...
        with(binding) {
            ...
            if (!titleText.isNullOrBlank()) {
                ...
                title.text = this@SimpleDialogAlt.titleText
            } else {
                title.isVisible = false
            }

            buttonPositive.text = positiveButtonText
            buttonPositiveContainer.setOnClickListener {
                dismiss()
                positiveButtonAction()
            }

            if (!negativeButtonText.isNullOrBlank()) {
                buttonPositiveContainer.isVisible = true
                buttonNegative.text = negativeButtonText

                buttonNegativeContainer.setOnClickListener {
                    dismiss()
                    negativeButtonAction?.invoke()
                }
            } else {
                buttonPositiveContainer.isVisible = false
            }
