...
public class ZoomageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    /**
     * Get the current {@linkAutoResetMode} mode of the image. Default value is {@link AutoResetMode#UNDER}.
     *
     * @return the current {@linkAutoResetMode} mode, one of {@link AutoResetMode#OVER OVER}, {@link AutoResetMode#UNDER UNDER},
     * {@linkAutoResetMode#ALWAYS ALWAYS}, or {@linkAutoResetMode#NEVER NEVER}
     */
    @AutoResetMode
    ...
    /**
     * Set the {@linkAutoResetMode} mode for the image.
     *
     * @param autoReset the desired mode, one of {@linkAutoResetMode#OVER OVER}, {@linkAutoResetMode#UNDER UNDER},
     *                  {@link.AutoResetMode#ALWAYS ALWAYS}, or {@linkAutoResetMode#NEVER NEVER}
     */
    ...
    /**
     * Reset the image based on the specified {@linkAutoResetMode} mode.
     */
    ...
    private void animateScaleAndTranslationToMatrix(final Matrix targetMatrix, final int duration) {
        ...
        resetAnimator.addListener(new SimpleAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mOnScaleListener != null && mScaling) {
                    mScaling = false;
    ...
    public void onScaleEnd(ScaleGestureDetector detector) {
        scaleBy = 1f;
        // mOnScaleListener#onScaleEnd moved to animation end
    }
